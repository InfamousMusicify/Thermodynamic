...
execute unless score #cryopop therm.config matches 1.. as @s[tag=!thermodynamic_off] anchored eyes positioned ^ ^ ^5 anchored feet unless entity @e[tag=cryopop_entity,tag=fuse,sort=nearest,distance=..4] run function thermodynamic:cryopop/place_loop
