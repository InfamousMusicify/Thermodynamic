...
# warning particles and sounds
execute unless score #azide_vis therm.config matches 1.. at @e[type=minecraft:armor_stand,tag=azide_entity,tag=fuse,scores={azide=1..,therm_track=20..}] run function thermodynamic:azide/fuse_vis
execute unless score #azide_sfx therm.config matches 1.. at @e[type=minecraft:armor_stand,tag=azide_entity,tag=fuse,scores={azide=1..,therm_track=20..}] run function thermodynamic:azide/fuse_sfx

scoreboard players set @e[type=minecraft:armor_stand,tag=azide_entity,tag=fuse,scores={azide=1..,therm_track=20..}] therm_track 0
# fire the bij
execute at @e[type=minecraft:armor_stand,tag=azide_entity,tag=fuse,scores={azide=0}] run function thermodynamic:azide/azide
