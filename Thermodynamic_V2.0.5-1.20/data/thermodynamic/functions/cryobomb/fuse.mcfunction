...
execute as @e[type=minecraft:armor_stand,tag=cryobomb_entity,tag=fuse,scores={cryobomb=1..}] run scoreboard players add @s therm_track 1
# score remover
...
execute unless score #cryobomb_sfx therm.config matches 1.. at @e[type=minecraft:armor_stand,tag=cryobomb_entity,tag=fuse,scores={cryobomb=1..,therm_track=20..}] run playsound minecraft:block.glass.break master @a[distance=..25]
execute unless score #cryobomb_sfx therm.config matches 1.. at @e[type=minecraft:armor_stand,tag=cryobomb_entity,tag=fuse,scores={cryobomb=1..,therm_track=20..}] run playsound minecraft:block.stone.break master @a[distance=..25]

execute as @e[type=minecraft:armor_stand,tag=cryobomb_entity,tag=fuse,scores={cryobomb=1..,therm_track=20..}] run scoreboard players set @s therm_track 0
# fire the bij
