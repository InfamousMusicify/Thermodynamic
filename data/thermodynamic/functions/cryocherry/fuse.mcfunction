...
execute unless score #cryocherry_vis therm.config matches 1.. at @e[type=minecraft:armor_stand,tag=cryocherry_entity,tag=fuse,scores={cryocherry=1..,therm_track=25..}] run particle minecraft:soul_fire_flame ~ ~.55 ~ 0 0 0 0.1 100 force
...
execute unless score #cryocherry_sfx therm.config matches 1.. at @e[type=minecraft:armor_stand,tag=cryocherry_entity,tag=fuse,scores={cryocherry=1..,therm_track=25..}] run playsound minecraft:block.glass.break master @a[distance=..20]

scoreboard players set @e[type=minecraft:armor_stand,tag=cryocherry_entity,tag=fuse,scores={cryocherry=1..,therm_track=25..}] therm_track 0
# fire the bij
