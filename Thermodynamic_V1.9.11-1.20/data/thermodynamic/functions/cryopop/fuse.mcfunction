...
execute unless score #cryopop_vis therm.config matches 1.. at @e[type=minecraft:armor_stand,tag=cryopop_entity,tag=fuse,scores={cryopop=1..}] run particle minecraft:soul_fire_flame ~ ~.55 ~ 0 0 0 0.1 500 force
#execute unless score #cryopop_vis therm.config matches 1.. at @e[type=minecraft:armor_stand,tag=cryopop_entity,tag=fuse,scores={cryopop=1..}] run particle minecraft:dolphin ~ ~.55 ~ 1.5 1.5 1.5 0.1 5000 force
