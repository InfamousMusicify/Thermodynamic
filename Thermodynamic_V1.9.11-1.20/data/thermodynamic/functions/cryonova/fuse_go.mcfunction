...
execute unless score #cryonova_vis therm.config matches 1.. unless entity @s[tag=cryonova_vis_off] at @s run particle minecraft:soul_fire_flame ~ ~.55 ~ 0 0 0 0.1 500 force
execute unless score #cryonova_vis therm.config matches 1.. unless entity @s[tag=cryonova_vis_off] at @s run particle minecraft:dolphin ~ ~.55 ~ 1.5 1.5 1.5 0.1 5000 force
execute unless score #cryonova_sfx therm.config matches 1.. unless entity @s[tag=cryonova_sfx_off] at @s run playsound minecraft:block.glass.break master @a[distance=..50]
# fire the bij
