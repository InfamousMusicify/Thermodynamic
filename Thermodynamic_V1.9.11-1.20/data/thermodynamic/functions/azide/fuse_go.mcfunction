...
execute unless score #azide_vis therm.config matches 1.. unless entity @s[tag=azide_vis_off] at @s run particle minecraft:lava ~ ~.55 ~ 1 1 1 1 250 force
execute unless score #azide_sfx therm.config matches 1.. unless entity @s[tag=azide_sfx_off] at @s run playsound minecraft:block.redstone_torch.burnout master @a[distance=..50]
# fire the bij
