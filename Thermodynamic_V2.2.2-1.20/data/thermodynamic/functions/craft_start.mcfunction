...
# data merge
execute as @e[limit=1,type=minecraft:item,sort=nearest,distance=..1,tag=therm_legs] run function thermodynamic:craft

execute unless entity @e[limit=1,type=minecraft:item,sort=nearest,distance=..1,tag=therm_legs] run function thermodynamic:craft_fail