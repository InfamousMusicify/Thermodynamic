...
execute if entity @s[scores={thermodynamic=0}] run execute as @s anchored eyes positioned ^ ^ ^7 anchored feet run function cryobomb:place_cryobomb/place_cryobomb_loop
#