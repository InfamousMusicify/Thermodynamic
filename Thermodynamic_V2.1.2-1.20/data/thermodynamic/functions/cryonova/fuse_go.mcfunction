...
execute unless entity @e[tag=cryonova_fused] as @e[type=minecraft:armor_stand,tag=cryonova_entity,tag=fuse,scores={cryonova=1..},limit=1] run schedule function thermodynamic:cryonova/fuse 1t
