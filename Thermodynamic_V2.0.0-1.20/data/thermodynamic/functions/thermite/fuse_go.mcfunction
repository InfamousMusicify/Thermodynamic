...
execute unless score #thermite_vis therm.config matches 1.. at @s run particle minecraft:lava ~ ~.55 ~ 1 1 1 1 50 force
execute unless score #thermite_sfx therm.config matches 1.. at @s run playsound minecraft:block.redstone_torch.burnout master @a[distance=..50]
# fire the bij
