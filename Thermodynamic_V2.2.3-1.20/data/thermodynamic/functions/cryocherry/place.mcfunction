...
execute unless score #cryocherry therm.config matches 1.. as @s[tag=!thermodynamic_off] anchored eyes positioned ^ ^ ^5 anchored feet unless entity @e[tag=cryocherry_entity,tag=fuse,sort=nearest,distance=..4] run function thermodynamic:cryocherry/place_loop
