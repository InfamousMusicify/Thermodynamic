...
execute unless entity @s[scores={thermo_cycle=1..}] run execute as @s anchored eyes positioned ^ ^ ^7 anchored feet run function cryobomb:place_cryobomb/place_cryobomb_loop
#