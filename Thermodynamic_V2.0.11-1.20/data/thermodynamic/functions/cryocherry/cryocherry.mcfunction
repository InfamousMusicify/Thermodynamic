...
# Lava Cool
fill ~-4 ~-7 ~-4 ~4 ~7 ~4 minecraft:magma_block replace minecraft:lava
fill ~-5 ~-6 ~-5 ~5 ~6 ~5 minecraft:magma_block replace minecraft:lava
fill ~-6 ~-5 ~-6 ~6 ~5 ~6 minecraft:magma_block replace minecraft:lava
fill ~-7 ~-4 ~-7 ~7 ~4 ~7 minecraft:magma_block replace minecraft:lava
# conduit
...
fill ~ ~ ~-1 ~ ~ ~1 minecraft:air replace minecraft:water
# Water
fill ~-2 ~-5 ~-2 ~2 ~5 ~2 minecraft:air replace #minecraft:drylog[waterlogged=true]
...
# everything
fill ~-2 ~-5 ~-2 ~2 ~5 ~2 minecraft:ice replace #minecraft:waterlog
...
execute unless score #cryocherry_efct therm.config matches 1.. as @e[sort=nearest] unless entity @s[gamemode=creative] unless entity @s[gamemode=spectator] unless entity @s[nbt={Inventory:[{Slot:102b, tag:{display:{Lore:['{"text":"Chains+","color":"gray","italic":false}']}}}]}] unless entity @s[nbt={Inventory:[{Slot:102b, tag: {armElyData: {chestplate: {id: "minecraft:netherite_chestplate"}}}}]}] unless entity @s[nbt={Inventory:[{Slot:101b, tag:{display:{Lore:['{"text":"Thermodynamic","color":"gray","italic":false}']}}}]}] unless entity @s[nbt={Inventory:[{Slot:102b, id: "minecraft:netherite_chestplate"}]}] at @e[type=minecraft:armor_stand,tag=cryocherry_entity,limit=1,tag=!fuse,sort=nearest] run function thermodynamic:cryocherry/effect
