...
execute as @e[type=minecraft:armor_stand,tag=cryopop_entity,tag=fuse,scores={cryopop=1..}] run scoreboard players add @s therm_track 1
# score remover
...
execute as @e[type=minecraft:armor_stand,tag=cryopop_entity,tag=fuse,scores={cryopop=1..,therm_track=20..}] run scoreboard players set @s therm_track 0
# fire the bij
